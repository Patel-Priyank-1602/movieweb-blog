...
const notifications: Notification[] = [
  {
    ...
    type: "release",
    title: "Coolie",
    message: "Coolie is now available! Watch the explosive return of Rajinikanth in this high-octane action drama.",
    movieTitle: "New Release",
    movieSlug: "coolie",
    movieType: "Movie",
    movieImage: "/series/cl.webp?height=450&width=300",
    isRead: false,
    actionUrl: "/released/coolie",
    priority: "high",
  ...
  },
  {
    ...
    movieSlug: "war-2",
    movieType: "Movie",
    movieImage: "/series/warr.webp?height=450&width=300",
    isRead: false,
    actionUrl: "/released/war-2",
    priority: "high",
    category: "Action/Thriller",
  },
    {
    ...
    type: "release",
    title: "Alien: earth",
    message: "Alien: earth is now available! Experience the epic journey of the Na'vi in this new installment.",
    movieTitle: "New Release",
    movieSlug: "coolie",
    movieType: "Series",
    movieImage: "/series/aal.webp?height=450&width=300",
    isRead: false,
    actionUrl: "/released/alien-earth",
    priority: "medium",
    category: "Horror",
  },

  {
    ...
    movieSlug: "wednesday",
    movieType: "Series",
    movieImage: "/series/wenc.webp?height=450&width=300",
    isRead: false,
  ...
  },
  {
    ...
    movieTitle: "New Release",
    movieSlug: "the-bad-guys-2",
    movieType: "Movie",
    movieImage: "/series/bd.webp?height=450&width=300",
    isRead: false,
    actionUrl: "/released/the-bad-guys-2",
    priority: "high",
    category: "Family/Comedy",
  },
  {
    ...
    movieType: "Movie",
    movieImage: "/series/zoo.webp?height=450&width=300",
    isRead: false,
    actionUrl: "/upcoming/zootopia-2",
    priority: "high",
    category: "Family/Comedy",
  },
  {
    ...
    movieSlug: "avatar-3",
    movieType: "Movie",
    movieImage: "/series/av.webp?height=450&width=300",
    isRead: false,
  ...
  },
  {
    ...
    movieType: "Movie",
    movieImage: "/series/ma.webp?height=450&width=300",
    isRead: false,
  ...
  },
  {
    ...
    movieType: "Movie",
    movieImage: "/series/fanc.webp?height=450&width=300",
    isRead: false,
