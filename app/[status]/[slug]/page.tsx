...
function getMovieData(slug: string, status: string) {
  ...
  const moviesData = {
    ...
    "raid-2": {
      title: "Raid 2",
      type: "Movie",
      posterImage: "/series/radc.webp?height=450&width=300",
      coverImage: "/series/rad.webp?height=600&width=1200",
      ...
      streamingPlatforms: [
        { name: "Netflix", image: "/icons/netflix.webp", url: "https://www.netflix.com/in/title/81760050" },
      ],
    },
    thunderbolt: {
      title: "Thunderbolt",
      type: "Movie",
      posterImage: "/series/thnc.webp?height=450&width=300",
      coverImage: "/series/thnn.webp?height=600&width=1200",
      releaseDate: "May 1, 2025",
      ...
      status: status === "released" ? "released" : "released",
      streamingPlatforms: [
        { name: "Prime Video", image: "/icons/primev.webp", url: "https://www.primevideo.com/detail/Thunderbolts/0NHFIZLPDPLA503QCNMNCWG0LH" },
        { name: "Apple TV+", image: "/icons/appletv.webp", url: "https://tv.apple.com/us/movie/thunderbolts/umc.cmc.67bgkyn0fzr8n7ngw0v4mi2df" },
      ],
    },
    chhava: {
      title: "Chhava",
      type: "Movie",
      posterImage: "/series/ch.webp?height=450&width=300",
      coverImage: "/series/chc.webp?height=600&width=1200",
      ...
      status: status === "released" ? "released" : "released",
      streamingPlatforms: [{ name: "Netflix", image: "/icons/netflix.webp", url: "https://www.netflix.com/in/title/81902061" }],
    },
    "final-destination": {
      title: "Final Destination Bloodlines",
      type: "Movie",
      posterImage: "/series/fdc.webp?height=450&width=300",
      coverImage: "/series/fd.webp?height=600&width=1200",
      ...
      status: status === "released" ? "released" : "released",
      streamingPlatforms: [
        { name: "Prime Video", image: "/icons/primev.webp", url: "https://www.primevideo.com/detail/Final-Destination-Bloodlines/0HQWQLL7HKLA4LEUNTS3ANVMP7" },
        { name: "Apple TV+", image: "/icons/appletv.webp", url: "https://tv.apple.com/in/movie/final-destination-bloodlines/umc.cmc.5qfqpx54akwcmzwfwwwq43kb5" },
      ],
    },
    "mission-impossible-final-reckoning": {
      title: "Mission Impossible: Final Reckoning",
      type: "Movie",
      posterImage: "/series/mic.webp?height=450&width=300",
      coverImage: "/series/mi.webp?height=600&width=1200",
      ...
      status: status === "released" ? "released" : "released",
      streamingPlatforms: [
        { name: "Apple TV+", image: "/icons/appletv.webp", url: "https://tv.apple.com/us/movie/mission-impossible---the-final-reckoning/umc.cmc.492oh9izvznxkfxk934zdz941" },
        { name: "Prime Video", image: "/icons/primev.webp", url: "https://www.primevideo.com/detail/Mission-Impossible---The-Final-Reckoning/0KT5HNE3OBR4TOFORPUHDR4G9U" },
      ],
    },
    "ballerina": {
      title: "Ballerina",
      type: "Movie",
      posterImage: "/series/ban.webp?height=450&width=300",
      coverImage: "/series/banc.webp?height=600&width=1200",
      ...
      status: status === "released" ? "released" : "released",
      streamingPlatforms: [
        { name: "Prime Video", image: "/icons/primev.webp", url: "https://www.primevideo.com/detail/BALLERINA-FROM-THE-WORLD-OF-JOHN-WICK/0OX3M1GTROXBOOUMLU14EX2D94" },
        { name: "Apple TV+", image: "/icons/appletv.webp", url: "https://tv.apple.com/in/movie/ballerina-from-the-world-of-john-wick/umc.cmc.2dniikyfhc78agajle1hsckfw?action=play" },
      ],
    },
    "captain-america-brave-new-world": {
      title: "Captain America: Brave New World",
      type: "Movie",
      posterImage: "/series/cam.webp?height=450&width=300",
      coverImage: "/series/camp.webp?height=600&width=1200",
      releaseDate: "February 14, 2025",
      ...
      status: status === "released" ? "released" : "released",
      streamingPlatforms: [
        { name: "Jio Hotstar", image: "/icons/jioh.webp", url: "https://www.hotstar.com/in/movies/captain-america-brave-new-world/1271337438" },
        { name: "Prime Video", image: "/icons/primev.webp", url: "https://www.primevideo.com/detail/Captain-America-Brave-New-World/0PQWXONK7YBT2JKTFUF0ZXAKNF" },
        { name: "Apple TV+", image: "/icons/appletv.webp", url: "https://tv.apple.com/us/movie/captain-america-brave-new-world/umc.cmc.3nc4irsrl9u6jk87kytlbvqu2" }
      ],
    },
    "28-years-later": {
      title: "28 Years Later",
      type: "Movie",
      posterImage: "/series/28y.webp?height=450&width=300",
      coverImage: "/series/28yc.webp?height=600&width=1200",
      ...
      status: status === "released" ? "released" : "released",
      streamingPlatforms: [
        { name: "Prime Video", image: "/icons/primev.webp", url: "https://www.primevideo.com/detail/28-Years-Later/0PWT8O5128DA0DYUWYLZP7ONVB" },
        { name: "Apple TV+", image: "/icons/appletv.webp", url: "https://tv.apple.com/us/movie/28-years-later/umc.cmc.1by2zb4d0qbto5tumjnsn40da" },
      ],
    },
    "sitaare-zameen-par": {
      title: "Sitaare Zameen Par",
      type: "Movie",
      posterImage: "/series/si.webp?height=450&width=300",
      coverImage: "/series/sic.webp?height=600&width=1200",
      releaseDate: "June 20, 2025",
    ...
    "how-to-train-your-dragon": {
      ...
      type: "Movie",
      posterImage: "/series/htt.webp?height=450&width=300",
      coverImage: "/series/httdd.webp?height=600&width=1200",
      ...
      status: "released",
      streamingPlatforms: [
        { name: "Prime Video", image: "/icons/primev.webp", url: "https://www.primevideo.com/detail/How-to-Train-Your-Dragon-2025/0RDCY52NPSM1U7B61TVG4QYADL" },
        { name: "Apple TV+", image: "/icons/appletv.webp", url: "https://tv.apple.com/us/movie/how-to-train-your-dragon/umc.cmc.6xnfodk272f9zoyd6y7rlu4tw" },
      ],
    },
    "f1-the-movie": {
      title: "F1: The Movie",
      type: "Movie",
      posterImage: "/series/f1.webp?height=450&width=300",
      coverImage: "/series/f1c.webp?height=600&width=1200",
      ...
      status: status === "released" ? "released" : "released",
      streamingPlatforms: [
        { name: "Apple TV+", image: "/icons/appletv.webp", url: "https://tv.apple.com/us/movie/f1-the-movie/umc.cmc.3t6dvnnr87zwd4wmvpdx5came" },
        { name: "Prime Video", image: "/icons/primev.webp", url: "https://www.amazon.com/F1-Joseph-Kosinski/dp/B0DK9TQT7V" },
      ],
    },
    "minecraft-the-movie": {
      title: "Minecraft: The Movie",
      type: "Movie",
      posterImage: "/series/mnc.webp?height=450&width=300",
      coverImage: "/series/mn.webp?height=600&width=1200",
      ...
      status: status === "released" ? "released" : "released",
      streamingPlatforms: [
        { name: "Apple TV+", image: "/icons/appletv.webp", url: "https://tv.apple.com/in/movie/a-minecraft-movie/umc.cmc.1od4a1ayyjqn43uz8fel7ei5e?action=play" },
        { name: "Prime Video", image: "/icons/primev.webp", url: "https://www.primevideo.com/dp/amzn1.dv.gti.f939f84b-b792-4f6f-82ea-7432a332c90a?autoplay=0&ref_=atv_cf_strg_wb" },
      ],
    },
    "kesari-chapter-2": {
      title: "Kesari: Chapter 2",
      type: "Movie",
      posterImage: "/series/kc.webp?height=450&width=300",
      coverImage: "/series/kcc.webp?height=600&width=1200",
      ...
      status: status === "released" ? "released" : "released",
      streamingPlatforms: [
        { name: "JioHotstar", image: "/icons/Jioh.webp", url: "https://www.hotstar.com/in/movies/kesari-chapter-2/1271423966" },
      ],
    },
    "dragon": {
      title: "Dragon",
      type: "Movie",
      posterImage: "/series/dr.webp?height=450&width=300",
      coverImage: "/series/drc.webp?height=600&width=1200",
    ...
    "jurassic-world-rebirth": {
      ...
      type: "Movie",
      posterImage: "/series/ju.webp?height=450&width=300",
      coverImage: "/series/juu.webp?height=600&width=1200",
      ...
      status: status === "released" ? "released" : "released",
      streamingPlatforms: [
        { name: "Apple TV+", image: "/icons/appletv.webp", url: "https://tv.apple.com/us/movie/jurassic-world-rebirth/umc.cmc.70puysxqi6jvumt17hpngqjbb" },
        { name: "Prime Video", image: "/icons/primev.webp", url: "https://www.primevideo.com/detail/Jurassic-World-Rebirth/0LDEOBW5YKKQBSLD80CPD0J6UY" },
      ],
    },
    "eleven": {
      title: "Eleven",
      type: "Movie",
      posterImage: "/series/ele.webp?height=450&width=300",
      coverImage: "/series/elec.webp?height=600&width=1200",
      releaseDate: "May 16, 2025",
    ...
    "lilo-stitch": {
      title: "Lilo & Stitch",
      type: "Movie",
      posterImage: "/series/ls.webp?height=450&width=300",
      coverImage: "/series/lsc.webp?height=600&width=1200",
      ...
      status: status === "released" ? "released" : "released",
      streamingPlatforms: [
        { name: "Prime Video", image: "/icons/Primev.webp", url: "https://www.primevideo.com/detail/Lilo-Stitch-2025/0RIK82RI02E0638IH1I0YIKADR" },
        { name: "Apple TV+", image: "/icons/appletv.webp", url: "https://tv.apple.com/us/movie/lilo--stitch-2025/umc.cmc.3zbigg07xzhmyf3h7uvkdsaua" },
      ],
    },
    superman: {
      title: "Superman",
      type: "Movie",
      posterImage: "/series/suc.webp?height=450&width=300",
      coverImage: "/series/su.webp?height=600&width=1200",
    ...
    "fantastic-4": {
      title: "Fantastic 4",
      type: "Movie",
      posterImage: "/series/fanc.webp?height=450&width=300",
      coverImage: "/series/fann.webp?height=600&width=1200",
    ...
    "mahavatar-narsimha": {
      ...
      type: "Movie",
      posterImage: "/series/ma.webp?height=450&width=300",
      coverImage: "/series/mac.webp?height=600&width=1200",
      releaseDate: "July 25, 2025",
    ...
    "the-bad-guys-2": {
      ...
      type: "Movie",
      posterImage: "/series/bd.webp?height=450&width=300",
      coverImage: "/series/bdc.webp?height=600&width=1200",
    ...
    "war-2": {
      title: "War 2",
      type: "Movie",
      posterImage: "/series/warr.webp?height=450&width=300",
      coverImage: "/series/warc.webp?height=600&width=1200",
    ...
    "coolie": {
      title: "Coolie",
      type: "Movie",
      posterImage: "/series/cl.webp?height=450&width=300",
      coverImage: "/series/clc.webp?height=600&width=1200",
      releaseDate: "August 14, 2025",
    ...
    "the-conjuring": {
      ...
      type: "Movie",
      posterImage: "/series/can.webp?height=450&width=300",
      coverImage: "/series/canc.webp?height=600&width=1200",
    ...
    "avatar-3": {
      title: "Avatar 3",
      type: "Movie",
      posterImage: "/series/av.webp?height=450&width=300",
      coverImage: "/series/avvvv.webp?height=600&width=1200",
    ...
    "zootopia-2": {
      title: "Zootopia 2",
      type: "Movie",
      posterImage: "/series/zoo.webp?height=450&width=300",
      coverImage: "/series/zooc.webp?height=600&width=1200",
    ...
    "demon-slayer-kimetsu-no-yaiba-infinity-castle-arc": {
      ...
      type: "Movie",
      posterImage: "/series/dl.webp?height=450&width=300",
      coverImage: "/series/dlc.webp?height=600&width=1200",
    ...
    "predator-badlands": {
      ...
      type: "Movie",
      posterImage: "/series/pb.webp?height=450&width=300",
      coverImage: "/series/pbc.webp?height=600&width=1200",
    ...
    you: {
      title: "You",
      type: "Series",
      posterImage: "/series/youc.webp?height=450&width=300",
      coverImage: "/series/you.webp?height=600&width=1200",
      ...
      status: status === "released" ? "released" : "released",
      streamingPlatforms: [
        { name: "Netflix", image: "/icons/netflix.webp", url: "https://www.netflix.com/in/title/80211991" },
      ],
    },
    adolescence: {
      title: "Adolescence",
      type: "Series",
      posterImage: "/series/adc.webp?height=450&width=300",
      coverImage: "/series/ad.webp?height=600&width=1200",
      ...
      status: status === "released" ? "released" : "released",
      streamingPlatforms: [
        { name: "Netflix", image: "/icons/netflix.webp", url: "https://www.netflix.com/in/title/81756069?source=35&fromWatch=true" },
      ],
    },
    "pataal-lok": {
      title: "Pataal Lok",
      type: "Series",
      posterImage: "/series/patc.webp?height=450&width=300",
      coverImage: "/series/pat.webp?height=600&width=1200",
      ...
      status: status === "released" ? "released" : "released",
      streamingPlatforms: [
        { name: "Prime Video", image: "/icons/primev.webp", url: "https://www.primevideo.com/detail/Paatal-Lok/0TJUQYHPIQC5R8KOUZ5P1C3F22" },
      ],
    },
    "the-last-of-us": {
      title: "The Last of Us",
      type: "Series",
      posterImage: "/series/thlou.webp?height=450&width=300",
      coverImage: "/series/thlouc.webp?height=600&width=1200",
      ...
      status: status === "released" ? "released" : "released",
      streamingPlatforms: [
        { name: "JioHotstar", image: "/icons/jioh.webp", url: "https://www.hotstar.com/in/shows/the-last-of-us/1971002868?search_query=The+Last+of+Us+2025  " },
        { name: "Prime Video", image: "/icons/primev.webp", url: "https://www.primevideo.com/detail/The-Last-of-Us/0G20ZS1Z1H28FQAJIVU3PBTI4Y" },
      ],
    },
    daredevil: {
      title: "Daredevil",
      type: "Series",
      posterImage: "/series/dar.webp?height=450&width=300",
      coverImage: "/series/darr.webp?height=600&width=1200",
      ...
      status: status === "released" ? "released" : "released",
      streamingPlatforms: [
        { name: "JioHotstar", image: "/icons/jioh.webp", url: "https://www.hotstar.com/in/shows/daredevil-born-again/1271337449" },
      ],
    },
    "khakee-the-bengal-chapter": {
      title: "Khakee: The Bengal Chapter",
      type: "Series",
      posterImage: "/series/kk.webp?height=450&width=300",
      coverImage: "/series/kkc.webp?height=600&width=1200",
      ...
      status: status === "released" ? "released" : "released",
      streamingPlatforms: [
        { name: "Netflix", image: "/icons/netflix.webp", url: "https://www.netflix.com/in/title/81995349?source=35&fromWatch=true" },
      ],
    },
    panchayat: {
      title: "Panchayat",
      type: "Series",
      posterImage: "/series/panc.webp?height=450&width=300",
      coverImage: "/series/pannn.webp?height=600&width=1200",
      ...
      status: status === "released" ? "released" : "released",
      streamingPlatforms: [
        { name: "Prime Video", image: "/icons/primev.webp", url: "https://www.primevideo.com/detail/Panchayat/0S889MF6A5RLBABFIURRMZ51MJ" },
      ],
    },
    "squid-game": {
      title: "Squid Game",
      type: "Series",
      posterImage: "/series/sq.webp?height=450&width=300",
      coverImage: "/series/sqc.webp?height=600&width=1200",
      releaseDate: "June 27, 2025",
      ...
      status: status === "released" ? "released" : "released",
      streamingPlatforms: [
        { name: "Netflix", image: "/icons/netflix.webp", url: "https://www.netflix.com/in/title/81040344" },
      ],
    },
    "ironheart": {
      title: "Ironheart",
      type: "Series",
      posterImage: "/series/ir.webp?height=450&width=300",
      coverImage: "/series/irc.webp?height=600&width=1200",
      releaseDate: "June 24, 2025",
      ...
      status: status === "released" ? "released" : "released",
      streamingPlatforms: [
        { name: "JioHotstar", image: "/icons/jioh.webp", url: "https://www.hotstar.com/in/shows/ironheart/1271341039" },
      ],
    },
    "criminal-justice": {
      title: "Criminal Justice",
      type: "Series",
      posterImage: "/series/cr.webp?height=450&width=300",
      coverImage: "/series/crc.webp?height=600&width=1200",
      ...
      status: status === "released" ? "released" : "released",
      streamingPlatforms: [
        { name: "JioHotstar", image: "/icons/jioh.webp", url: "https://www.hotstar.com/in/shows/criminal-justice/1271316088" },
      ],
    },
    "the-sandman": {
      title: "The Sandman",
      type: "Series",
      posterImage: "/series/sad.webp?height=450&width=300",
      coverImage: "/series/sadc.webp?height=600&width=1200",
      ...
      status: status === "released" ? "released" : "released",
      streamingPlatforms: [
        { name: "Netflix", image: "/icons/netflix.webp", url: "https://www.netflix.com/in/title/81150303" },
      ],
    },
    "special-ops-2": {
      title: "Special OPS 2",
      type: "Series",
      posterImage: "/series/sp.webp?height=450&width=300",
      coverImage: "/series/spc.webp?height=600&width=1200",
      ...
      status: status === "released" ? "released" : "released",
      streamingPlatforms: [
        { name: "JioHotstar", image: "/icons/Jioh.webp", url: "https://www.hotstar.com/in/shows/special-ops/1260022894?search_query=Special+OPS+2" },
      ],
    },
    "alien-earth": {
      title: "Alien: Earth",
      type: "Series",
      posterImage: "/series/aal.webp?height=450&width=300",
      coverImage: "/series/aalc.webp?height=600&width=1200",
      ...
      status: "released",
      streamingPlatforms: [
        { name: "JioHotstar", image: "/icons/Jioh.webp", url: "https://www.hotstar.com/in/shows/alien-earth/1271381985" },
      ],
    },
    // Series - Upcoming
    "stranger-things": {
      ...
      type: "Series",
      posterImage: "/series/stc.webp?height=450&width=300",
      coverImage: "/series/stcc.webp?height=600&width=1200",
      releaseDate: "November 26, 2025",
    ...
    "alice-in-borderland": {
      ...
      type: "Series",
      posterImage: "/series/aibb.webp?height=450&width=300",
      coverImage: "/series/aib.webp?height=600&width=1200",
    ...
    wednesday: {
      title: "Wednesday",
      type: "Series",
      posterImage: "/series/wenc.webp?height=450&width=300",
      coverImage: "/series/wen.webp?height=600&width=1200",
      ...
      status: status === "released" ? "released" : "released",
      streamingPlatforms: [
        { name: "Netflix", image: "/icons/netflix.webp", url: "https://www.netflix.com/in/title/81231974" },
      ],
    },
    "family-man": {
      title: "Family Man",
      type: "Series",
      posterImage: "/series/fm.webp?height=450&width=300",
      coverImage: "/series/fmc.webp?height=600&width=1200",
    ...
    "the-witcher": {
      title: "The Witcher",
      type: "Series",
      posterImage: "/series/wi.webp?height=450&width=300",
      coverImage: "/series/wic.webp?height=600&width=1200",
